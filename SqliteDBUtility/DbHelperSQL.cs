...
namespace SqliteDBUtility
{
    ...
    public class DbHelperSQL
    {
        ...
        public static DataTable GetData(string cmdText, int start, int max)
        {
        ...
        /// 带参数的查询存储过程
        /// </summary>
        /// <param name="proc">查询语句</param>
        /// <param name="value">参数</param>
        /// <returns>查询所得到的表</returns>
        public static DataTable GetTable(string proc, SqlParameter[] value)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlDataAdapter da = new SqlDataAdapter(proc, connection);
                // da.SelectCommand.CommandTimeout = 180;
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddRange(value);
                DataSet ds = new DataSet();
                da.Fill(ds);
                return ds.Tables[0];
            }
        ...
        public static int RunProc(string proc, SqlParameter[] value)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlDataAdapter da = new SqlDataAdapter(proc, connection);
        ...
        public static int RunProce(string storedProcName, IDataParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet dataSet = new DataSet();

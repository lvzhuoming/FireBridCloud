 ...
 *文件名：  XmlHelper
 *创建人：  吕焯明
 *创建时间：2016-10-19 9:31:14
 *描述
 *=====================================================================
 *修改标记
 *修改时间：2016-10-19 9:31:14
 *修改人： 吕焯明
 *描述：
************************************************************************************/
using System;
...
namespace DBUtility
{
    ...
    public class XmlHelper
    {
        ...
        public static XmlDocument objXmlDoc = new XmlDocument();
        ...
        public static void Replace(string XmlPathNode, string Content)
        {
            //更新节点内容。 
        ...
        public static void DeleteChild(string Node)
        {
            //删除一个节点。 
        ...
        public static void InsertElement(string MainNode, string Element, string Attrib, string AttribContent, string Content)
        {
            //插入一个节点，带一属性。 
        ...
        /// <param name="Element">元素</param>
        /// <param name="Content">元素内容</param>
        public static void InsertElement(string MainNode, string Element, string Content)
        {
            //插入一个节点，不带属性。 
            XmlNode objNode = objXmlDoc.SelectSingleNode(MainNode);
            XmlElement objElement = objXmlDoc.CreateElement(Element);
